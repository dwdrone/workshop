...
1. The **3DR Solo UAV** (drone)
2. The **3DR Sololink** (GCS controller)
3. The **Solex Android app**
4. The **3DR GoPro Hero 4 payload**
5. All communication links between components
